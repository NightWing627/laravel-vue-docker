...
Vue.component('modal-select-date-trade', require('./components/modal/SelectDateTrade.vue').default);
...
// Test
Vue.component('nav-bar-component', require('./components/common/navbar.vue').default);
